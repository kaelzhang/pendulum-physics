...
```bash
$ cortex install pendulum-physics --save
```
...
```js
var pendulum_physics = require('pendulum-physics');
```
...
### Class: pendulum_physics(options)
<!-- 
...
Creates a new pendulum-physics instance.
...
### pendulum-physics.&lt;method-name&gt;(arguments)
